        ...
        <div className="flex gap-2">
          {onEdit && (
            <button
              ...
              className="rounded-md p-1.5 text-sm text-slate-400 transition-colors hover:text-blue-400"
          ...
          {onDelete && (
            <button
              ...
              className="rounded-md p-1.5 text-sm text-slate-400 transition-colors hover:text-red-400"
